        ...
        <div className="container max-w-4xl mx-auto px-4 py-6 sm:py-10">
          <div className="mb-6 sm:mb-8 text-center">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
              Lucre vendendo bolos de pote, brigadeiros e outras sobremesas artesanais
              do {settings.storeName}, com preço especial de atacado e suporte próximo.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2 mb-6 sm:mb-8">
            <Card className="h-full">
              <CardHeader className="flex flex-row items-center gap-2">
                ...
                <CardTitle className="text-base sm:text-lg">
                  Preço especial para revenda
                </CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  Compre nossos bolos de pote com preço de atacado e revenda com
                  excelente margem de lucro. Ideal para quem quer complementar
                  a renda ou montar um negócio de sobremesas.
                </p>
            ...
            <Card className="h-full">
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  Além dos bolos de pote, você também pode revender outros
                  produtos do {settings.storeName}:
                </p>
                <ul className="list-disc list-inside space-y-1">
            ...
            <Card className="h-full">
              <CardHeader className="flex flex-row items-center gap-2">
                ...
                <CardTitle className="text-base sm:text-lg">
                  Negócio simples e lucrativo
                </CardTitle>
              </CardHeader>
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  Trabalhe com produtos de alta saída e ótimo custo-benefício.
                  Venda em empresas, escolas, condomínios, igrejas, eventos e
                  muito mais.
                </p>
                <ul className="list-disc list-inside space-y-1">
            ...
            <Card className="h-full">
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  Te ajudamos com orientações de conservação, exposição,
                  montagem de cardápio e sugestões de preços.
                </p>
                <ul className="list-disc list-inside space-y-1">
          ...
          <Card className="mb-6 sm:mb-8">
            <CardHeader>
              <CardTitle className="text-base sm:text-lg">
                Como funciona para ser revendedor(a)?
              </CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground space-y-3">
              <ol className="list-decimal list-inside space-y-1">
                <li>Clique no botão <strong>"Saiba mais no WhatsApp"</strong>.</li>
                ...
                <li>Faça seu primeiro pedido e comece a vender na sua região.</li>
              </ol>
              <p className="pt-2">
                É simples, sem burocracia e perfeito para quem quer começar a
                empreender com doces artesanais.
              </p>
            </CardContent>
          </Card>
          ...
          <p className="text-xs text-muted-foreground text-center max-w-xl mx-auto">
            As condições para revendedores podem mudar conforme a demanda da produção.
            Ao enviar mensagem, nossa equipe vai te orientar sobre valores atualizados,
            sabores disponíveis e quantidade mínima de pedidos.
          </p>
        </div>
      </PageTransition>
    </StoreLayout>
